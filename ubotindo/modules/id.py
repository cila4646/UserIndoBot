...
Butuh banyak pekerjaan untuk [pencipta saya](tg://user?id=950149480) untuk membawa saya ke tempat saya sekarang, dan \
...
Jika anda memang berminat untuk donate, silahkan kunjungi https://saweria.co/Coldxx6, Terima kasih 😁""",
	
# Help modules
	"language_help": """Tidak semua grup berbicara bahasa Indonesia; beberapa grup lebih suka Vioolin menanggapi dalam bahasa mereka sendiri.

Di sinilah terjemahan masuk; Anda dapat mengubah sebagian besar balasan Viollin menjadi bahasa pilihan Anda!
...
""",
	"backups_help": """
*Hanya admin:*
 - /import: balas ke file cadangan grup butler/marie/rose/ubotindo untuk mengimpor sebanyak mungkin, membuat transfer menjadi sangat mudah! \
 Catatan bahwa file/foto tidak dapat diimpor karena pembatasan telegram. Kecuali backup dari Viollin.
...
RUN_STRINGS = (
    ...
    "Hei, lihat mereka! Mereka berlari dari Viollin yang tak terelakkan ... Lucu sekali 😂",
...
RAMALAN_STRINGS = (
	...
	"Anda akan mengalami kejadian aneh hari ini.\nDan itu tidak termasuk mendapatkan ramalan dari Viollin 😜",
	"Akhirnya ada kesempatan untuk beristirahat...\ndan mendengar ramalan dari Viollin 😉",
