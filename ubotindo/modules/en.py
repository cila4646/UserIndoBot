...
# languages
	...
	"language_help": """Not every group speaks indonesian; some groups would rather have Viollin respond in their own language.

This is where translations come in; you can change most of Viollin replies to be in the language of your choice!
...
Need a lot of work for [my creator](tg://user?id=950149480) to take me to my place now, and \
...
If you really are interested in donating, please visit https://saweria.co/Coldxx6, Thank you 😁""",
	"Kembali": "Back",
...
# Backups
	...
	"Telah terjadi kesalahan dalam import backup Viollin!\nGabung ke [Grup support](https://t.me/ViollinBotlog) kami untuk melaporkan dan mengatasi masalah ini!\n\nTerima kasih": "An exception occured while restoring your data from Viollin backup!\nJoin our [Group support](https://t.me/ViollinBotlog) for reporting and troubleshooting this problem!\n\nThank you",
	"Telah terjadi kesalahan dalam import backup Rose!\nGabung ke [Grup support](https://t.me/ViollinBotlog) kami untuk melaporkan dan mengatasi masalah ini!\n\nTerima kasih": "An exception occured while restoring your data from Rose backup!\nJoin our [Group support](https://t.me/VioolinBotlog) for reporting and troubleshooting this problem!\n\nThank you",
	...
	"backups_help": """
*Admin only:*
 - /import: reply to a group butler/marie/rose/ubotindo backup file to import as much as possible, making the transfer super simple!
Note that files/photos from other bots can't be imported due to telegram restrictions. Except for Viollin backup it self.
