...
from ubotindo import dispatcher, spamcheck, LOGGER
from ubotindo.modules.disable import DisableAbleCommandHandler
from ubotindo.modules.helper_funcs.chat_status import user_admin_no_reply, user_admin

from ubotindo.modules.sql import languages_sql as sql
...
for x in os.listdir('ubotindo/modules/langs'):
	if os.path.isdir('ubotindo/modules/langs/'+x):
		continue
	x = x.replace('.py', '')
	LOADED_LANGS_ID.append(x)
	imported_langs = importlib.import_module("ubotindo.modules.langs." + x)
...
def set_language(update, context):
	...
	loaded_langs.append([InlineKeyboardButton("Translate", url="https://github.com/green987/UserIndoBot/blob/master/TRANSLATION.md")])
